...
public:
	...
	SCSITargetDevicePath *	getObject ( unsigned int index ) const APPLE_KEXT_OVERRIDE;
...
protected:
	...
	bool InitializePathManagerForTarget (
						...
						IOSCSIProtocolServices * 	initialPath ) APPLE_KEXT_OVERRIDE;
...
public:
	...
	virtual SCSIServiceResponse		AbortTask ( SCSILogicalUnitNumber theLogicalUnit, SCSITaggedTaskIdentifier theTag ) APPLE_KEXT_OVERRIDE;
	virtual SCSIServiceResponse		AbortTaskSet ( SCSILogicalUnitNumber theLogicalUnit ) APPLE_KEXT_OVERRIDE;
	virtual SCSIServiceResponse		ClearACA ( SCSILogicalUnitNumber theLogicalUnit ) APPLE_KEXT_OVERRIDE;
	virtual SCSIServiceResponse		ClearTaskSet ( SCSILogicalUnitNumber theLogicalUnit ) APPLE_KEXT_OVERRIDE;
	virtual SCSIServiceResponse		LogicalUnitReset ( SCSILogicalUnitNumber theLogicalUnit ) APPLE_KEXT_OVERRIDE;
	virtual SCSIServiceResponse		TargetReset ( void ) APPLE_KEXT_OVERRIDE;
	virtual void					TaskCompletion ( SCSITaskIdentifier request, SCSITargetDevicePath * path ) APPLE_KEXT_OVERRIDE;
	
	bool		AddPath ( IOSCSIProtocolServices * path ) APPLE_KEXT_OVERRIDE;
	void		ActivatePath ( IOSCSIProtocolServices * path );
	void		InactivatePath ( IOSCSIProtocolServices * path );
	void		RemovePath ( IOSCSIProtocolServices * path ) APPLE_KEXT_OVERRIDE;
	void		PathStatusChanged ( IOSCSIProtocolServices * path, SCSIPortStatus newStatus ) APPLE_KEXT_OVERRIDE;
