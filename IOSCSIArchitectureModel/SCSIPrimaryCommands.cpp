    			...
    			SCSICmdField1Byte 			CONTROL )
{
	...
	__Require ( IsParameterValid ( SAVE, kSCSICmdFieldMask1Bit ), ErrorExit );
	__Require ( IsParameterValid ( DEFINITION_PARAMETER, kSCSICmdFieldMask7Bit ), ErrorExit );
	__Require ( IsParameterValid ( PARAMETER_DATA_LENGTH, kSCSICmdFieldMask1Byte ), ErrorExit );
	__Require ( IsParameterValid ( CONTROL, kSCSICmdFieldMask1Byte ), ErrorExit );
	__Require ( IsBufferAndCapacityValid ( dataBuffer, PARAMETER_DATA_LENGTH ), ErrorExit );
    			...
    			SCSICmdField1Byte 			CONTROL )
{
	...
	__Require ( IsParameterValid ( PAD, kSCSICmdFieldMask1Bit ), ErrorExit );
	__Require ( IsParameterValid ( PARAMETER_LIST_LENGTH, kSCSICmdFieldMask3Byte ), ErrorExit );
	__Require ( IsParameterValid ( CONTROL, kSCSICmdFieldMask1Byte ), ErrorExit );
	__Require ( IsBufferAndCapacityValid ( dataBuffer, PARAMETER_LIST_LENGTH ), ErrorExit );
    			...
    			SCSICmdField1Byte 			CONTROL )
{
	...
	__Require ( IsParameterValid ( BYTCHK, kSCSICmdFieldMask1Bit ), ErrorExit );
	__Require ( IsParameterValid ( PAD, kSCSICmdFieldMask1Bit ), ErrorExit );
	__Require ( IsParameterValid ( PARAMETER_LIST_LENGTH, kSCSICmdFieldMask3Byte ), ErrorExit );
	__Require ( IsParameterValid ( CONTROL, kSCSICmdFieldMask1Byte ), ErrorExit );
	__Require ( IsBufferAndCapacityValid ( dataBuffer, PARAMETER_LIST_LENGTH ), ErrorExit );
    			...
    			SCSICmdField1Byte 			CONTROL )
{
	...
	__Require ( IsParameterValid ( PARAMETER_LIST_LENGTH, kSCSICmdFieldMask4Byte ), ErrorExit );
	__Require ( IsParameterValid ( CONTROL, kSCSICmdFieldMask1Byte ), ErrorExit );
	__Require ( IsBufferAndCapacityValid ( dataBuffer, PARAMETER_LIST_LENGTH ), ErrorExit );
    			...
    			SCSICmdField1Byte 			CONTROL )
{
	...
	__Require ( IsParameterValid ( CMDDT, kSCSICmdFieldMask1Bit ), ErrorExit );
	__Require ( IsParameterValid ( EVPD, kSCSICmdFieldMask1Bit ), ErrorExit );
	__Require ( IsParameterValid ( PAGE_OR_OPERATION_CODE, kSCSICmdFieldMask1Byte ), ErrorExit );
	__Require ( IsParameterValid ( ALLOCATION_LENGTH, kSCSICmdFieldMask1Byte ), ErrorExit );
	__Require ( IsParameterValid ( CONTROL, kSCSICmdFieldMask1Byte ), ErrorExit );
	__Require ( IsBufferAndCapacityValid ( dataBuffer, ALLOCATION_LENGTH ), ErrorExit );
    			...
    			SCSICmdField1Byte 			CONTROL )
{
	...
	__Require ( IsParameterValid ( PCR, kSCSICmdFieldMask1Bit ), ErrorExit );
	__Require ( IsParameterValid ( SP, kSCSICmdFieldMask1Bit ), ErrorExit );
	__Require ( IsParameterValid ( PC, kSCSICmdFieldMask2Bit ), ErrorExit );
	__Require ( IsParameterValid ( PARAMETER_LIST_LENGTH, kSCSICmdFieldMask2Byte ), ErrorExit );
	__Require ( IsParameterValid ( CONTROL, kSCSICmdFieldMask1Byte ), ErrorExit );
	__Require ( IsBufferAndCapacityValid ( dataBuffer, PARAMETER_LIST_LENGTH ), ErrorExit );
    			...
    			SCSICmdField1Byte 			CONTROL )
{
	...
	__Require ( IsParameterValid ( PPC, kSCSICmdFieldMask1Bit ), ErrorExit );
	__Require ( IsParameterValid ( SP, kSCSICmdFieldMask1Bit ), ErrorExit );
	__Require ( IsParameterValid ( PC, kSCSICmdFieldMask2Bit ), ErrorExit );
	__Require ( IsParameterValid ( PAGE_CODE, kSCSICmdFieldMask6Bit ), ErrorExit );
	__Require ( IsParameterValid ( PARAMETER_POINTER, kSCSICmdFieldMask2Byte ), ErrorExit );
	__Require ( IsParameterValid ( ALLOCATION_LENGTH, kSCSICmdFieldMask2Byte ), ErrorExit );
	__Require ( IsParameterValid ( CONTROL, kSCSICmdFieldMask1Byte ), ErrorExit );
	__Require ( IsBufferAndCapacityValid ( dataBuffer, ALLOCATION_LENGTH ), ErrorExit );
    			...
    			SCSICmdField1Byte 			CONTROL )
{
	...
	__Require ( IsParameterValid ( PF, kSCSICmdFieldMask1Bit ), ErrorExit );
	__Require ( IsParameterValid ( SP, kSCSICmdFieldMask1Bit ), ErrorExit );
	__Require ( IsParameterValid ( PARAMETER_LIST_LENGTH, kSCSICmdFieldMask1Byte ), ErrorExit );
	__Require ( IsParameterValid ( CONTROL, kSCSICmdFieldMask1Byte ), ErrorExit );
	__Require ( IsBufferAndCapacityValid ( dataBuffer, PARAMETER_LIST_LENGTH ), ErrorExit );
    			...
    			SCSICmdField1Byte 			CONTROL )
{
	...
	__Require ( IsParameterValid ( DBD, kSCSICmdFieldMask1Bit ), ErrorExit );
	__Require ( IsParameterValid ( PC, kSCSICmdFieldMask2Bit ), ErrorExit );
	__Require ( IsParameterValid ( PAGE_CODE, kSCSICmdFieldMask6Bit ), ErrorExit );
	__Require ( IsParameterValid ( ALLOCATION_LENGTH, kSCSICmdFieldMask1Byte ), ErrorExit );
	__Require ( IsParameterValid ( CONTROL, kSCSICmdFieldMask1Byte ), ErrorExit );
				...
				SCSICmdField1Byte 			CONTROL )
{
	...
	__Require ( IsParameterValid ( LLBAA, kSCSICmdFieldMask1Bit ), ErrorExit );
	__Require ( IsParameterValid ( DBD, kSCSICmdFieldMask1Bit ), ErrorExit );
	__Require ( IsParameterValid ( PC, kSCSICmdFieldMask2Bit ), ErrorExit );
	__Require ( IsParameterValid ( PAGE_CODE, kSCSICmdFieldMask6Bit ), ErrorExit );
	__Require ( IsParameterValid ( ALLOCATION_LENGTH, kSCSICmdFieldMask2Byte ), ErrorExit );
    			...
    			SCSICmdField1Byte 			CONTROL )
{
	...
	__Require ( IsParameterValid ( SERVICE_ACTION, kSCSICmdFieldMask5Bit ), ErrorExit );
	__Require ( IsParameterValid ( ALLOCATION_LENGTH, kSCSICmdFieldMask2Byte ), ErrorExit );
	__Require ( IsParameterValid ( CONTROL, kSCSICmdFieldMask1Byte ), ErrorExit );
	__Require ( IsBufferAndCapacityValid ( dataBuffer, ALLOCATION_LENGTH ), ErrorExit );
    			...
    			SCSICmdField1Byte 			CONTROL )
{
	...
	__Require ( IsParameterValid ( SERVICE_ACTION, kSCSICmdFieldMask5Bit ), ErrorExit );
	__Require ( IsParameterValid ( SCOPE, kSCSICmdFieldMask4Bit ), ErrorExit );
	__Require ( IsParameterValid ( TYPE, kSCSICmdFieldMask4Bit ), ErrorExit );
	__Require ( IsParameterValid ( CONTROL, kSCSICmdFieldMask1Byte ), ErrorExit );
	__Require ( IsBufferAndCapacityValid ( dataBuffer, 0x18 ), ErrorExit );
    			...
    			SCSICmdField1Byte 			CONTROL )
{
	...
	__Require ( IsParameterValid ( PREVENT, kSCSICmdFieldMask2Bit ), ErrorExit );
	__Require ( IsParameterValid ( CONTROL, kSCSICmdFieldMask1Byte ), ErrorExit );
    			...
    			SCSICmdField1Byte 			CONTROL )
{
	...
	__Require ( IsParameterValid ( MODE, kSCSICmdFieldMask4Bit ), ErrorExit );
	__Require ( IsParameterValid ( BUFFER_ID, kSCSICmdFieldMask1Byte ), ErrorExit );
	__Require ( IsParameterValid ( BUFFER_OFFSET, kSCSICmdFieldMask3Byte ), ErrorExit );
	__Require ( IsParameterValid ( ALLOCATION_LENGTH, kSCSICmdFieldMask3Byte ), ErrorExit );
	__Require ( IsParameterValid ( CONTROL, kSCSICmdFieldMask1Byte ), ErrorExit );
	__Require ( IsBufferAndCapacityValid ( dataBuffer, ALLOCATION_LENGTH ), ErrorExit );
    			...
    			SCSICmdField1Byte 			CONTROL )
{
	...
	__Require ( IsParameterValid ( TRANSFER_LENGTH, kSCSICmdFieldMask3Byte ), ErrorExit );
	__Require ( IsParameterValid ( CONTROL, kSCSICmdFieldMask1Byte ), ErrorExit );
	__Require ( IsBufferAndCapacityValid ( dataBuffer, TRANSFER_LENGTH ), ErrorExit );
    			...
    			SCSICmdField1Byte 			CONTROL )
{
	...
	__Require ( IsParameterValid ( SERVICE_ACTION, kSCSICmdFieldMask5Bit ), ErrorExit );
	__Require ( IsParameterValid ( LIST_IDENTIFIER, kSCSICmdFieldMask1Byte ), ErrorExit );
	__Require ( IsParameterValid ( ALLOCATION_LENGTH, kSCSICmdFieldMask4Byte ), ErrorExit );
	__Require ( IsParameterValid ( CONTROL, kSCSICmdFieldMask1Byte ), ErrorExit );
	__Require ( IsBufferAndCapacityValid ( dataBuffer, ALLOCATION_LENGTH ), ErrorExit );
    			...
    			SCSICmdField1Byte 			CONTROL )
{
	...
	__Require ( IsParameterValid ( PCV, kSCSICmdFieldMask1Bit ), ErrorExit );
	__Require ( IsParameterValid ( PAGE_CODE, kSCSICmdFieldMask1Byte ), ErrorExit );
	__Require ( IsParameterValid ( ALLOCATION_LENGTH, kSCSICmdFieldMask2Byte ), ErrorExit );
	__Require ( IsParameterValid ( CONTROL, kSCSICmdFieldMask1Byte ), ErrorExit );
	__Require ( IsBufferAndCapacityValid ( dataBuffer, ALLOCATION_LENGTH ), ErrorExit );
				...
				SCSICmdField1Byte 			CONTROL )
{
	...
	__Require ( IsParameterValid ( THRDPTY, kSCSICmdFieldMask1Bit ), ErrorExit );
	__Require ( IsParameterValid ( LONGID, kSCSICmdFieldMask1Bit ), ErrorExit );
	__Require ( IsParameterValid ( THIRD_PARTY_DEVICE_ID, kSCSICmdFieldMask1Byte ), ErrorExit );
	__Require ( IsParameterValid ( PARAMETER_LIST_LENGTH, kSCSICmdFieldMask2Byte ), ErrorExit );
	__Require ( IsParameterValid ( CONTROL, kSCSICmdFieldMask1Byte ), ErrorExit );
	__Require ( IsBufferAndCapacityValid ( dataBuffer, PARAMETER_LIST_LENGTH ), ErrorExit );
				...
				SCSICmdField1Byte 			CONTROL )
{
	...
	__Require ( IsParameterValid ( THRDPTY, kSCSICmdFieldMask1Bit ), ErrorExit );
	__Require ( IsParameterValid ( LONGID, kSCSICmdFieldMask1Bit ), ErrorExit );
	__Require ( IsParameterValid ( EXTENT, kSCSICmdFieldMask1Bit ), ErrorExit );
	__Require ( IsParameterValid ( RESERVATION_IDENTIFICATION, kSCSICmdFieldMask1Byte ), ErrorExit );
	__Require ( IsParameterValid ( THIRD_PARTY_DEVICE_ID, kSCSICmdFieldMask1Byte ), ErrorExit );
	__Require ( IsParameterValid ( PARAMETER_LIST_LENGTH, kSCSICmdFieldMask2Byte ), ErrorExit );
	__Require ( IsParameterValid ( CONTROL, kSCSICmdFieldMask1Byte ), ErrorExit );
	__Require ( IsBufferAndCapacityValid ( dataBuffer, PARAMETER_LIST_LENGTH ), ErrorExit );
    			...
    			SCSICmdField1Byte 			CONTROL )
{
	...
	__Require ( IsParameterValid ( AER, kSCSICmdFieldMask1Bit ), ErrorExit );
	__Require ( IsParameterValid ( TRANSFER_LENGTH, kSCSICmdFieldMask3Byte ), ErrorExit );
	__Require ( IsParameterValid ( CONTROL, kSCSICmdFieldMask1Byte ), ErrorExit );
				...
				SCSICmdField1Byte 			CONTROL )
{
	...
	__Require ( IsParameterValid ( SELF_TEST_CODE, kSCSICmdFieldMask3Bit ), ErrorExit );
	__Require ( IsParameterValid ( PF, kSCSICmdFieldMask1Bit ), ErrorExit );
	__Require ( IsParameterValid ( SELF_TEST, kSCSICmdFieldMask1Bit ), ErrorExit );
	__Require ( IsParameterValid ( DEVOFFL, kSCSICmdFieldMask1Bit ), ErrorExit );
	__Require ( IsParameterValid ( UNITOFFL, kSCSICmdFieldMask1Bit ), ErrorExit );
	__Require ( IsParameterValid ( PARAMETER_LIST_LENGTH, kSCSICmdFieldMask2Byte ), ErrorExit );
	__Require ( IsParameterValid ( CONTROL, kSCSICmdFieldMask1Byte ), ErrorExit );
	...
	if ( SELF_TEST == 1 )
	{
		...
		__Require ( ( SELF_TEST_CODE == 0x00 ), ErrorExit );
										...
										SCSICmdField1Byte mask )
{
	...
	__Require ( ( param | mask ) == mask, ErrorExit );
	valid = true;
				...
				UInt32						requiredSize )
{
	...
	bool	valid = false;
	__Require_noErr ( dataBuffer, ErrorExit );
	__Require ( ( dataBuffer->getLength ( ) >= requiredSize ), ErrorExit );
	valid = true;
