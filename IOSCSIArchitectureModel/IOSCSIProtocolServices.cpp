...
IOSCSIProtocolServices::start ( IOService * provider )
{
	...
	__Require_noErr ( fIOSCSIProtocolServicesReserved, ErrorExit );
	...
	__Require_noErr ( fQueueLock, FreeReserved );
...
FreeReserved:
	...
	__Require_noErr_Quiet ( fIOSCSIProtocolServicesReserved, ErrorExit );
